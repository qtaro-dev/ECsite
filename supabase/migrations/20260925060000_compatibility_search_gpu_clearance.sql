-- T23: extend published product search with the minimum GPU clearance needed by a selected GPU.
drop function public.search_published_products(text,text,text,text,integer,integer,jsonb,text,integer);
